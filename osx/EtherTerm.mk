...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch).. $(IncludeSwitch)../src $(IncludeSwitch)/usr/local/opt/sdl2/include $(IncludeSwitch)/usr/local/opt/sdl2/include/SDL2 $(IncludeSwitch)/usr/local/opt/libssh/include $(IncludeSwitch)/usr/local/opt/yaml-cpp/include 
IncludePCH             := 
RcIncludePath          := 
...
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch). $(LibraryPathSwitch).. $(LibraryPathSwitch)/usr/local/opt/sdl2/lib $(LibraryPathSwitch)/usr/local/opt/libssh/lib $(LibraryPathSwitch)/usr/local/opt/yaml-cpp/lib 
...
PreBuild:
	...
	/usr/local/opt/gnu-sed/libexec/gnubin/sed -i 's+..+..+' EtherTerm.mk
	@echo Done
