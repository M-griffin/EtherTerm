...
CFLAGS   :=  -g -O0 -pedantic -W -std=c++14 -Wall $(Preprocessors)
ASFLAGS  := 
...
Objects0=$(IntermediateDirectory)/up_src_SDL2_net_SDLnet.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_SDL2_net_SDLnetselect.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_SDL2_net_SDLnetTCP.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_SDL2_net_SDLnetUDP.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_io_service.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_socket_telnet.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_window_manager.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_link_list.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_socket_irc.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_irc_manager.cpp$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/up_src_session_manager.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_socket_ssh.cpp$(ObjectSuffix) $(IntermediateDirectory)/up_src_telnet_manager.cpp$(ObjectSuffix) 
...
PostBuild:
	...
	'C:\Program Files (x86)\GnuWin32\bin\sed.exe' -i 's+C:/Users/Blue/Desktop/EtherTerm/src+../src/+' C:\Users\Blue\Desktop\EtherTerm\win32\EtherTerm.mk
	'C:\Program Files (x86)\GnuWin32\bin\sed.exe' -i 's+C:/Users/Blue/Desktop/EtherTerm/win32+./EtherTerm/win32+' C:\Users\Blue\Desktop\EtherTerm\win32\EtherTerm.mk
	del /Q sed*
	@echo Done
...
$(IntermediateDirectory)/up_src_dialing_directory_dao.cpp$(ObjectSuffix): ../src/dialing_directory_dao.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/EtherTerm/src/dialing_directory_dao.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_dialing_directory_dao.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_menu_dao.cpp$(ObjectSuffix): ../src/menu_dao.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_src_menu_dao.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/up_src_menu_dao.cpp$(DependSuffix) -MM ../src/menu_dao.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/EtherTerm/src/menu_dao.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_menu_dao.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_src_menu_dao.cpp$(PreprocessSuffix): ../src/menu_dao.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_src_menu_dao.cpp$(PreprocessSuffix) ../src/menu_dao.cpp
...
$(IntermediateDirectory)/up_src_font_manager.cpp$(ObjectSuffix): ../src/font_manager.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/EtherTerm/src/font_manager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_font_manager.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_dialing_manager.cpp$(ObjectSuffix): ../src/dialing_manager.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/EtherTerm/src/dialing_manager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_dialing_manager.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_src_font_set_dao.cpp$(ObjectSuffix): ../src/font_set_dao.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Blue/Desktop/EtherTerm/src/font_set_dao.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_src_font_set_dao.cpp$(ObjectSuffix) $(IncludePath)
