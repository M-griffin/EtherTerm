    ...
    while( SDL_PollEvent( &event ) != 0 )
    {
            ...
            event.key.keysym.mod & KMOD_ALT)
        {
            ...
            else
            {
                ...
                {
                    case 0: SDL_SetWindowSize(TheTerm::Instance()->getWindow(), 640, 400);
                        ++fullScreenWindowSize;
                        break;

                    case 1: SDL_SetWindowSize(TheTerm::Instance()->getWindow(), 800, 520);
                        ++fullScreenWindowSize;
                        break;

                    case 2: SDL_SetWindowSize(TheTerm::Instance()->getWindow(), 1440, 800);
                        ++fullScreenWindowSize;
                        fullScreen = false;
                        break;
                }
