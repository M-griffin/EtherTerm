...
CXX      := clang++
CC       := clang
CXXFLAGS :=  -g -O0 -W -std=c++11 $(Preprocessors)
CFLAGS   :=  -g -O0 -W -std=c++11 $(Preprocessors)
ASFLAGS  := 
AS       := llvm-as
